      ...
      <main className="dashboard-content">
        ...
        <div className="glass-panel share-card">
          ...
          <p className="share-desc">
            Recommandez Photonet à vos proches commerçants, créateurs de contenu ou e-commerçants. Lorsqu'ils s'inscrivent et rechargent leur compte pour propulser leurs ventes, vous encaissez immédiatement <strong>30% de commission cash</strong> sur leurs 3 premiers achats !
          </p>
